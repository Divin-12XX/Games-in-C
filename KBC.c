...
{  int choice,pass;
   ...
   system("CLS");
    ...
    if(pass==1234)
    {
       ...
       switch(choice)
      { case 1:
       balance=easy(balance);
        break;
        case 2:
        balance=medium(balance);
        break;
        case 3:
        balance=elite(balance);
        break;
       default:
       printf("Your choice id Unacceptable");
       printf("Try Again");
...
int elite(long long int balance)
{    
    ...
    printf("\n");
    printf("=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n");
    printf("You Have Won:1cr 11lac 10 thousand Rs ");
    printf("\n=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n");
    balance+=3101000;
    return balance;
    }
    ...
    printf("\n");
    printf("=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n");
    printf("You Have Won:11lac 10 thousand Rs ");
    printf("\n=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n");
    balance+=1101000;
    return balance;  
    }
    ...
    printf("\n");
    printf("=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n");
    printf("You Have Won:1lac 10 thousand Rs ");
    printf("\n=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n");
    balance+=1010000;
    return balance;
    }
    ...
    printf("\n");
    printf("=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n");
    printf("You Have Won:10 thousand Rs ");
    printf("\n=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n");
    balance+=10000;
    return balance;
...
int easy(long long int balance)
{
...
int medium(long long int balance)
{    
    int a,ans1,ans2,ans3,ans4,ans5;
    system("CLS");
    printf("=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=\n");
